...
export const IconAtom: React.FC<{ className?: string }> = ({ className }) => (
...
export const IconShield: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a37.453 37.453 0 01-1.043 3.296 3.745 3.745 0 01-2.104 1.415 39.055 39.055 0 01-1.996.306 37.24 37.24 0 01-2.267.265 37.24 37.24 0 01-2.267-.265 39.055 39.055 0 01-1.996-.306 3.745 3.745 0 01-2.104-1.415 37.453 37.453 0 01-1.043-3.296A3.745 3.745 0 013 12c0-1.268.63-2.39 1.593-3.068a37.453 37.453 0 011.043-3.296 3.746 3.746 0 012.104-1.415 39.055 39.055 0 011.996-.306 37.24 37.24 0 012.267-.265 37.24 37.24 0 012.267.265 39.055 39.055 0 011.996.306 3.746 3.746 0 012.104 1.415 37.453 37.453 0 011.043 3.296A3.745 3.745 0 0121 12z" />
  </svg>
);

export const IconRocket: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
     <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.631 8.41m5.96 5.96a14.926 14.926 0 01-5.841 2.58m-.119-8.54a6 6 0 00-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 00-2.58 5.84m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 01-2.448-2.448 14.9 14.9 0 01.06-.312m-2.24 2.39a4.493 4.493 0 00-1.757 4.306 4.493 4.493 0 004.306-1.758M16.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" />
  </svg>
);

export const IconSmartphone: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const IconWhatsApp: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M12 4a8 8 0 00-6.895 12.06l.569.918-.797 2.989 2.905-.883.883.535A8 8 0 1012 4zm0-2a10 10 0 11-5.352 18.455L2 22l4.635-1.405A10 10 0 0112 2z" clipRule="evenodd" opacity="0.4" />
    <path d="M16.82 15.007c-.255-.127-1.512-.746-1.746-.832-.234-.085-.404-.127-.574.128-.17.255-.659.831-.808 1.002-.149.17-.298.191-.553.063-.255-.127-1.078-.396-2.053-1.266-.757-.674-1.268-1.508-1.417-1.763-.149-.255-.016-.393.111-.52.115-.116.255-.3.383-.45.127-.148.17-.254.255-.424.085-.17.042-.319-.022-.446-.063-.127-.574-1.382-.786-1.892-.208-.496-.42-.428-.574-.435-.149-.007-.319-.007-.489-.007-.17 0-.447.064-.68.319-.234.255-.894.873-.894 2.129 0 1.256.915 2.469 1.042 2.639.128.17 1.8 2.748 4.362 3.854 2.562 1.106 2.562.738 3.03.695.468-.043 1.512-.617 1.724-1.213.213-.596.213-1.107.149-1.213-.064-.106-.234-.17-.489-.297z" />
  </svg>
);
